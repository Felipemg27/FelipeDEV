...
export default function List (){
    ...
    const _renderCard = (item:PropCard,index:number) =>{       
        ...
        const color  = item.flag == 'pago'?themas.Colors.blueLigth:themas.Colors.red
        return (
            <Swipeable  
    ...
    return(
        <View style={style.container}>
            ...
            <View style={style.header}>
                <Text style={style.greeting}>Bom dia! <Text style={{fontWeight:'bold'}}></Text></Text>
                <View style={style.boxInput}>
                <Text style={style.conta}>Mensalidades: <Text style={{fontWeight:'bold'}}></Text></Text>
                </View>
            </View>
